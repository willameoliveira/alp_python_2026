...
if opcao == 1:
    ...
    print(f"A média ponderada de peso 2 e 3 do seu número é {media_pond:.2f}")
elif opcao == 2:
    soma = (num1 + num2) ** 2
    print(f"O quadrado da soma dos dois números é {soma:.2f}")
elif opcao ==3:
    if num1 < num2:
        cubo1 = num1 **3
        print(f"O cubo do seu menor número é {cubo1:.2f}")
    else:
         cubo2 = num2 **3
         print(f"O cubo do seu menor número é {cubo2:.2f}")
else:
